...
const Footer = () => {
  return (
    <footer className="flex flex-row min-h-[200px] opacity-80">
    <div className="mt-37 ml-10 w-1/4 flex flex-col text-left"> © OneSport 2025</div>
  ...
  <a href="https://www.linkedin.com/in/piyushbanga/" className="relative inline-block ml-2">
    <span className="text-red-500 text-xl relative after:block after:h-[2px] after:w-0 after:bg-red-500 after:transition-all after:duration-300 after:ease-in-out hover:after:w-full hover:text-red-400">
      Piyush Banga
    </span>
  </a>
</li>
