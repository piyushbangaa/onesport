      ...
      <div className="flex flex-row mt-8 w-full">
        <div className="w-1/2 grid grid-cols-3 grid-rows-2 gap-6">
          {[
            ...
            { title: "4. Secure Booking", desc: "Pay securely via UPI, cards, or wallets. Receive booking confirmation via SMS with a booking ID." },
            ...
            <div key={index} className="p-4 border-2 border-gray-600 rounded-lg shadow-md">
